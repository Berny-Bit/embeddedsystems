// ======================================================================
// RemlichtTentamenv2.v generated from TopDesign.cysch
// 11/03/2019 at 20:23
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("e5867b45-eb6f-4008-945e-daecb3395187/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__rempedaal_net;
	wire [0:0] tmpFB_0__rempedaal_net;
	wire [0:0] tmpIO_0__rempedaal_net;
	wire [0:0] tmpINTERRUPT_0__rempedaal_net;
	electrical [0:0] tmpSIOVREF__rempedaal_net;
	...
	cy_psoc3_pins_v1_10
		...
		rempedaal
		 (.oe(tmpOE__rempedaal_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__rempedaal_net[0:0]}),
		  .io({tmpIO_0__rempedaal_net[0:0]}),
		  .siovref(tmpSIOVREF__rempedaal_net),
		  .interrupt({tmpINTERRUPT_0__rempedaal_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rempedaal_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__remlicht_net;
	wire [0:0] tmpFB_0__remlicht_net;
	wire [0:0] tmpIO_0__remlicht_net;
	wire [0:0] tmpINTERRUPT_0__remlicht_net;
	electrical [0:0] tmpSIOVREF__remlicht_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		remlicht
		 (.oe(tmpOE__remlicht_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__remlicht_net[0:0]}),
		  .io({tmpIO_0__remlicht_net[0:0]}),
		  .siovref(tmpSIOVREF__remlicht_net),
		  .interrupt({tmpINTERRUPT_0__remlicht_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__remlicht_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__achterlicht_net;
	wire [0:0] tmpFB_0__achterlicht_net;
	wire [0:0] tmpIO_0__achterlicht_net;
	wire [0:0] tmpINTERRUPT_0__achterlicht_net;
	electrical [0:0] tmpSIOVREF__achterlicht_net;

	cy_psoc3_pins_v1_10
		#(.id("aa6735c9-8815-4d51-8fc0-701d45b64ce1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		achterlicht
		 (.oe(tmpOE__achterlicht_net),
		  .y({Net_31}),
		  .fb({tmpFB_0__achterlicht_net[0:0]}),
		  .io({tmpIO_0__achterlicht_net[0:0]}),
		  .siovref(tmpSIOVREF__achterlicht_net),
		  .interrupt({tmpINTERRUPT_0__achterlicht_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__achterlicht_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_0 PWM_achterlicht (
        ...
        .ph1(Net_32),
        .ph2(Net_33));
    defparam PWM_achterlicht.Resolution = 8;


	cy_clock_v1_0
		#(.id("f381bfcb-ce0b-44c3-9ae7-51c13bf54ee9"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    cy_annotation_universal_v1_0 LDR (
        .connect({
            Net_39,
            Net_40
        })
    );
    defparam LDR.comp_name = "PhotoResistor_v1_0";
    defparam LDR.port_names = "T1, T2";
    defparam LDR.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("75b6527f-9522-4ee6-8487-e2b18883fc54"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
