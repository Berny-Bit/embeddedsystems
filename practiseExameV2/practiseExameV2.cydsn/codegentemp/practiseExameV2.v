// ======================================================================
// practiseExameV2.v generated from TopDesign.cysch
// 01/16/2020 at 18:02
...
module ADC_SAR_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("898dcf30-711d-43df-a995-55942555d754/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("da7b9cd7-1650-413e-b8fd-21e93e95f72d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("554c014b-6e84-43ac-8fc9-c2fd32d7ef10"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1c05c3bf-2d1b-4918-b5d3-1aaf6d29bc23"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__charger_indicator_net;
	wire [0:0] tmpFB_0__charger_indicator_net;
	wire [0:0] tmpIO_0__charger_indicator_net;
	wire [0:0] tmpINTERRUPT_0__charger_indicator_net;
	electrical [0:0] tmpSIOVREF__charger_indicator_net;

	cy_psoc3_pins_v1_10
		#(.id("768951b5-7863-4e39-b193-6438feb4d7c5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		charger_indicator
		 (.oe(tmpOE__charger_indicator_net),
		  .y({Net_67}),
		  .fb({tmpFB_0__charger_indicator_net[0:0]}),
		  .io({tmpIO_0__charger_indicator_net[0:0]}),
		  .siovref(tmpSIOVREF__charger_indicator_net),
		  .interrupt({tmpINTERRUPT_0__charger_indicator_net[0:0]}),
		  .annotation({Net_31}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__charger_indicator_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("ebadb46e-e440-4898-b9c5-b106c8565363"),
		  .source_clock_id(""),
		  .divisor(0),
